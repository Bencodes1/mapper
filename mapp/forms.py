...
class MapInputs(forms.Form):
    ...
    x_dim = forms.IntegerField(validators=[MinValueValidator(4), MaxValueValidator(200)], label = 'Image Resolution: Width', initial=200)
    y_dim = forms.IntegerField(validators=[MinValueValidator(2), MaxValueValidator(200)], label = 'Image Resolution: Height', initial=200)
